...
export const OcrIcon: React.FC<IconProps> = (props) => (
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}>
    <path d="M7 21H4a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h3"/>
    <path d="M17 3h3a2 2 0 0 1 2 2v3"/>
    <path d="M21 17v3a2 2 0 0 1-2 2h-3"/>
    <path d="M3 17v3"/>
    <path d="M11 8v8"/>
    <path d="M8 8h2a2 2 0 0 1 2 2v0a2 2 0 0 1-2 2H8"/>
    <path d="M14 8h2a2 2 0 0 1 2 2v1a2 2 0 0 1-2 2h-2"/>
  </svg>
);
...
export const SparkleIcon: React.FC<IconProps> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}>
        <path d="M9.9 2.25 11 5h2.5l-2 2 1 3-2.5-1.5L7.5 10l1-3-2-2H9l1.1-2.75Z"/>
        <path d="m14 14 1 2.5 2 1-2.5 1L14 21l-1-2.5-2-1 2.5-1L14 14Z"/>
        <path d="M3 7.5 4 10l2.5.5-2 2-1 2.5-1.5-2.5-2.5-1 2-2L3 7.5Z"/>
    </svg>
);
...
export const ClipboardPasteIcon: React.FC<IconProps> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}>
        ...
        <path d="M8 4H4a2 2 0 0 0-2 2v14a2 2 0 0 0 2 2h16a2 2 0 0 0 2-2V6a2 2 0 0 0-2-2h-4"/>
...
export const KeyIcon: React.FC<IconProps> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}>
      <path d="m21.73 18-8-14a2 2 0 0 0-3.46 0l-8 14A2 2 0 0 0 4 21h16a2 2 0 0 0 1.73-3Z" transform="rotate(135 12 12)" />
      <path d="M15.5 7.5 19 4l-2.5-2.5" transform="rotate(135 12 12)" />
      <circle cx="6" cy="18" r="3" transform="rotate(135 12 12)" />
    </svg>
  );